...
# The actual excercise had the data imported for us already, 
# but I will do it again just in case its needed.
load("~/Part-4-Exploratory-Data-Analysis-CHIS-excercise/CHIS2009_reduced_2")

# Install packages for ggplot and call library function:
